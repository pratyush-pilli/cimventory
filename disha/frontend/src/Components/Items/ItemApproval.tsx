...
interface ItemRequest {
  ...
  typeCode?: string;
  // New fields from database tables
  mpncode?: string;  // From factory_mpns table
  description?: string;  // From factory_ratings table
  packagedesc?: string;  // From factory_packages table
        ...
        <DialogContent>
          {editedRequest && (
            <Box sx={{ mt: 2 }}>
              ...
              {editedRequest.type === 'factory' ? (
                // FACTORY ITEM DETAILS
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="caption" color="textSecondary" display="block">
                      Product Code (Factory): {editedRequest.productCode}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="caption" color="textSecondary" display="block">
                      Make Code (Factory): {editedRequest.makeCode}
                    </Typography>
                  </Grid>

                  {/* MFG Part Number (MPN Full) */}
                  <Grid item xs={12} md={6}>
                    <Typography variant="body1">
                      <strong>Manufacturing Part Number:</strong> {editedRequest.mfgPartNo}
                    </Typography>
                    <Typography variant="caption" color="textSecondary" display="block">
                      MPN Code (Factory): {editedRequest.mpncode || editedRequest.mfgPartCode}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <Typography variant="body1">
                      <strong>Material Rating:</strong> {editedRequest.materialRating || editedRequest.description || "N/A"}
                    </Typography>
                    <Typography variant="caption" color="textSecondary" display="block">
                      Rating Code (Factory): {editedRequest.materialRatingCode || "N/A"}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <Typography variant="body1">
                      <strong>Package:</strong> {editedRequest.packagedesc || editedRequest.package || "N/A"}
                    </Typography>
                    <Typography variant="caption" color="textSecondary" display="block">
                      Package Code (Factory): {editedRequest.package || "N/A"}
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body1">
                      <strong>Item Description:</strong> {editedRequest.itemDescription}
                    </Typography>
                  </Grid>
                  ...
                  {/* MOQ */}
                  {editedRequest.moq !== undefined && editedRequest.moq !== null && (
                    <Grid item xs={12} md={6}>
                      <Typography variant="body1">
                  ...
                  {/* Lead Time */}
                  {editedRequest.leadTime !== undefined && editedRequest.leadTime !== null && (
                    <Grid item xs={12} md={6}>
                      <Typography variant="body1">
                        <strong>Lead Time:</strong> {editedRequest.leadTime} days
                      </Typography>
                    </Grid>
                  )}
                ...
                // PURCHASE ITEM DETAILS (Original Logic)
                <Grid container spacing={3}>
                  {/* Product Name */}
                  <Grid item xs={12}>
                    <Typography variant="body1">
                  ...
                  <Grid item xs={12} md={6}>
                    <Typography variant="body1">
                      <strong>Description:</strong> {editedRequest.itemDescription}
                    </Typography>
                    <Typography variant="caption" color="textSecondary" display="block">
                  ...
                  <Grid item xs={12} md={6}>
                    <Typography variant="body1">
                      <strong>Material Rating:</strong> {editedRequest.materialRating || "N/A"}
                    </Typography>
                      ...
                      <Paper elevation={1} sx={{ p: 2, mt: 2, bgcolor: "#f0f8ff" }}>
                        <Box display="flex" alignItems="center" justifyContent="space-between">
                          <Box display="flex" alignItems="center">
                            ...
                            <Typography variant="body1">
                              Document: {editedRequest.document_name || "Attached documentation"}
                            </Typography>
                          </Box>
                          <Button
                            size="small"
