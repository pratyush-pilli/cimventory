...
class FactoryMake(models.Model):
    ...
    class Meta:
        ...
        unique_together = (
            ('productid', 'makecode'),
            ('productid', 'makename'),  # Prevent duplicate make names per product
        )
        indexes = [
...
class FactoryItemRequest(models.Model):
    ...
    makecode = models.CharField(max_length=255, db_index=True)
    mpnfull = models.CharField(max_length=255, db_index=True)
    mpncode = models.CharField(max_length=10, blank=True, null=True, db_index=True)  # From factory_mpns table
    ratingvalue = models.CharField(max_length=255, blank=True, null=True)
    description = models.TextField(blank=True, null=True)  # From factory_ratings table
    packagecode = models.CharField(max_length=255, blank=True, null=True)
    packagedesc = models.TextField(blank=True, null=True)  # From factory_packages table
    itemdesc = models.TextField()  # From factory_itemdescription table
